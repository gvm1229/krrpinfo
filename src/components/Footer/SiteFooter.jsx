...
export function SiteFooter({ className }) {
  return (
    ...
    >
      <div
        className="flex flex-col items-center justify-between gap-4 mobile_only:container tablet_only:container mobile_only:py-4 tablet:h-24 tablet:flex-row desktop:px-8"
      >
